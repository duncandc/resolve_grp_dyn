...
def return_mock_resolve(halocat, model, gal_prop_cut=10**8.0):
    ...
    sub_start = time.time()
    galaxy_sample['halo_x'] = galaxy_sample['halo_x'] - halocat.Lbox[0]/2.0
    galaxy_sample['halo_y'] = galaxy_sample['halo_y'] - halocat.Lbox[0]/2.0
    galaxy_sample['halo_z'] = galaxy_sample['halo_z'] - halocat.Lbox[0]/2.0
