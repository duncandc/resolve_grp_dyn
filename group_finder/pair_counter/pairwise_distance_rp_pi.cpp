...
#define __PYX_HAVE__pair_counter__pairwise_distance_rp_pi
#define __PYX_HAVE_API__pair_counter__pairwise_distance_rp_pi
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  "pair_counter/pairwise_distance_rp_pi.pyx",
  "__init__.pxd",
  "pair_counter/stringsource",
  "type.pxd",
};
...
/* Module declarations from 'pair_counter.pairwise_distance_rp_pi' */
...
#define __Pyx_MODULE_NAME "pair_counter.pairwise_distance_rp_pi"
int __pyx_module_is_main_pair_counter__pairwise_distance_rp_pi = 0;

/* Implementation of 'pair_counter.pairwise_distance_rp_pi' */
...
static char __pyx_k_Users_duncan_Documents_projects[] = "/Users/duncan/Documents/projects/RESOLVE_project/group_finder/pair_counter/pairwise_distance_rp_pi.pyx";
...
static char __pyx_k_pair_counter_pairwise_distance_r[] = "pair_counter.pairwise_distance_rp_pi";
...
static PyObject *__pyx_n_s_pair_counter_pairwise_distance_r;
...
/* "pair_counter/pairwise_distance_rp_pi.pyx":18
...
/* Python wrapper */
static PyObject *__pyx_pw_12pair_counter_23pairwise_distance_rp_pi_1pairwise_distance_rp_pi(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_12pair_counter_23pairwise_distance_rp_pi_pairwise_distance_rp_pi[] = " \n    Cython engine for returning pairs of points and perendicular and parallel \n    seperation with an observer at (0,0)\n    \n    Parameters \n    ------------\n    x1in, y1in, z1in : arrays \n        Numpy arrays storing Cartesian coordinates of points in sample 1\n    \n    x2in, y2in, z2in : arrays \n        Numpy arrays storing Cartesian coordinates of points in sample 2\n    \n    rp_max : array\n        maximum perpendicular separation distance to search for and return pairs\n    \n    pi_max : array\n        maximum parallel separation distance to search for and return pairs\n    \n    Returns \n    --------\n    rp_distance : numpy.array\n        array of perpednicular pairwise separation distances\n    \n    pi_distance : numpy.array\n        array of parallel pairwise separation distances\n    \n    i : numpy.array\n        array of 0-indexed indices in sample 1\n    \n    j : numpy.array\n        array of 0-indexed indices in sample2\n    \n    ";
static PyMethodDef __pyx_mdef_12pair_counter_23pairwise_distance_rp_pi_1pairwise_distance_rp_pi = {"pairwise_distance_rp_pi", (PyCFunction)__pyx_pw_12pair_counter_23pairwise_distance_rp_pi_1pairwise_distance_rp_pi, METH_VARARGS|METH_KEYWORDS, __pyx_doc_12pair_counter_23pairwise_distance_rp_pi_pairwise_distance_rp_pi};
static PyObject *__pyx_pw_12pair_counter_23pairwise_distance_rp_pi_1pairwise_distance_rp_pi(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pair_counter.pairwise_distance_rp_pi.pairwise_distance_rp_pi", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12pair_counter_23pairwise_distance_rp_pi_pairwise_distance_rp_pi(__pyx_self, __pyx_v_x1in, __pyx_v_y1in, __pyx_v_z1in, __pyx_v_x2in, __pyx_v_y2in, __pyx_v_z2in, __pyx_v_rp_max, __pyx_v_pi_max);
...
static PyObject *__pyx_pf_12pair_counter_23pairwise_distance_rp_pi_pairwise_distance_rp_pi(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_x1in, PyObject *__pyx_v_y1in, PyObject *__pyx_v_z1in, PyObject *__pyx_v_x2in, PyObject *__pyx_v_y2in, PyObject *__pyx_v_z2in, PyObject *__pyx_v_rp_max, PyObject *__pyx_v_pi_max) {
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":53
 *     """
 * 
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":54
 * 
 *     cdef cnp.float64_t rp_max_p = rp_max
 *     cdef cnp.float64_t pi_max_p = pi_max             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":56
 *     cdef cnp.float64_t pi_max_p = pi_max
 * 
 *     cdef cnp.float64_t[:] x1 = np.ascontiguousarray(x1in, dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":57
 * 
 *     cdef cnp.float64_t[:] x1 = np.ascontiguousarray(x1in, dtype=np.float64)
 *     cdef cnp.float64_t[:] y1 = np.ascontiguousarray(y1in, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef cnp.float64_t[:] z1 = np.ascontiguousarray(z1in, dtype=np.float64)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":58
 *     cdef cnp.float64_t[:] x1 = np.ascontiguousarray(x1in, dtype=np.float64)
 *     cdef cnp.float64_t[:] y1 = np.ascontiguousarray(y1in, dtype=np.float64)
 *     cdef cnp.float64_t[:] z1 = np.ascontiguousarray(z1in, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef cnp.float64_t[:] x2 = np.ascontiguousarray(x2in, dtype=np.float64)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":59
 *     cdef cnp.float64_t[:] y1 = np.ascontiguousarray(y1in, dtype=np.float64)
 *     cdef cnp.float64_t[:] z1 = np.ascontiguousarray(z1in, dtype=np.float64)
 *     cdef cnp.float64_t[:] x2 = np.ascontiguousarray(x2in, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef cnp.float64_t[:] y2 = np.ascontiguousarray(y2in, dtype=np.float64)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":60
 *     cdef cnp.float64_t[:] z1 = np.ascontiguousarray(z1in, dtype=np.float64)
 *     cdef cnp.float64_t[:] x2 = np.ascontiguousarray(x2in, dtype=np.float64)
 *     cdef cnp.float64_t[:] y2 = np.ascontiguousarray(y2in, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef cnp.float64_t[:] z2 = np.ascontiguousarray(z2in, dtype=np.float64)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":61
 *     cdef cnp.float64_t[:] x2 = np.ascontiguousarray(x2in, dtype=np.float64)
 *     cdef cnp.float64_t[:] y2 = np.ascontiguousarray(y2in, dtype=np.float64)
 *     cdef cnp.float64_t[:] z2 = np.ascontiguousarray(z2in, dtype=np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":70
 *     cdef int Ni, Nj, i, j
 * 
 *     Ni = len(x1)             # <<<<<<<<<<<<<<
 *     Nj = len(x2)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":71
 * 
 *     Ni = len(x1)
 *     Nj = len(x2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":74
 * 
 *     #loop over points in cell1 points
 *     for i in range(0,Ni):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "pair_counter/pairwise_distance_rp_pi.pyx":76
 *     for i in range(0,Ni):
 *         #loop over points in cell2 points
 *         for j in range(0,Nj):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":78
 *         for j in range(0,Nj):
 *             #calculate the square distance
 *             sx = x1[i] - x2[j]             # <<<<<<<<<<<<<<
 *             sy = y1[i] - y2[j]
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":79
 *             #calculate the square distance
 *             sx = x1[i] - x2[j]
 *             sy = y1[i] - y2[j]             # <<<<<<<<<<<<<<
 *             sz = z1[i] - z2[j]
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":80
 *             sx = x1[i] - x2[j]
 *             sy = y1[i] - y2[j]
 *             sz = z1[i] - z2[j]             # <<<<<<<<<<<<<<
 *             lx = 0.5*(x1[i] + x2[j])
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":81
 *             sy = y1[i] - y2[j]
 *             sz = z1[i] - z2[j]
 *             lx = 0.5*(x1[i] + x2[j])             # <<<<<<<<<<<<<<
 *             ly = 0.5*(y1[i] + y2[j])
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":82
 *             sz = z1[i] - z2[j]
 *             lx = 0.5*(x1[i] + x2[j])
 *             ly = 0.5*(y1[i] + y2[j])             # <<<<<<<<<<<<<<
 *             lz = 0.5*(z1[i] + z2[j])
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":83
 *             lx = 0.5*(x1[i] + x2[j])
 *             ly = 0.5*(y1[i] + y2[j])
 *             lz = 0.5*(z1[i] + z2[j])             # <<<<<<<<<<<<<<
 *             l2 = (lx * lx) + (ly * ly) + (lz * lz)
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":84
 *             ly = 0.5*(y1[i] + y2[j])
 *             lz = 0.5*(z1[i] + z2[j])
 *             l2 = (lx * lx) + (ly * ly) + (lz * lz)             # <<<<<<<<<<<<<<
 *             ll = sqrt(l2)
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":85
 *             lz = 0.5*(z1[i] + z2[j])
 *             l2 = (lx * lx) + (ly * ly) + (lz * lz)
 *             ll = sqrt(l2)             # <<<<<<<<<<<<<<
 *             spar = abs(((sx * lx) + (sy * ly) + (sz * lz)) / ll)
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":86
 *             l2 = (lx * lx) + (ly * ly) + (lz * lz)
 *             ll = sqrt(l2)
 *             spar = abs(((sx * lx) + (sy * ly) + (sz * lz)) / ll)             # <<<<<<<<<<<<<<
 *             s2 = (sx * sx) + (sy * sy) + (sz * sz)
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":87
 *             ll = sqrt(l2)
 *             spar = abs(((sx * lx) + (sy * ly) + (sz * lz)) / ll)
 *             s2 = (sx * sx) + (sy * sy) + (sz * sz)             # <<<<<<<<<<<<<<
 *             sperp = sqrt(s2 - spar * spar)
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":88
 *             spar = abs(((sx * lx) + (sy * ly) + (sz * lz)) / ll)
 *             s2 = (sx * sx) + (sy * sy) + (sz * sz)
 *             sperp = sqrt(s2 - spar * spar)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "pair_counter/pairwise_distance_rp_pi.pyx":90
 *             sperp = sqrt(s2 - spar * spar)
 * 
 *             if (spar <= pi_max_p) & (sperp <= rp_max_p):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_25) {
        ...
        /* "pair_counter/pairwise_distance_rp_pi.pyx":91
 * 
 *             if (spar <= pi_max_p) & (sperp <= rp_max_p):
 *                 rp_distances.push_back(sperp)             # <<<<<<<<<<<<<<
 *                 pi_distances.push_back(spar)
 ...
 */
        ...
        /* "pair_counter/pairwise_distance_rp_pi.pyx":92
 *             if (spar <= pi_max_p) & (sperp <= rp_max_p):
 *                 rp_distances.push_back(sperp)
 *                 pi_distances.push_back(spar)             # <<<<<<<<<<<<<<
 *                 i_ind.push_back(i)
 ...
 */
        ...
        /* "pair_counter/pairwise_distance_rp_pi.pyx":93
 *                 rp_distances.push_back(sperp)
 *                 pi_distances.push_back(spar)
 *                 i_ind.push_back(i)             # <<<<<<<<<<<<<<
 *                 j_ind.push_back(j)
 ...
 */
        ...
        /* "pair_counter/pairwise_distance_rp_pi.pyx":94
 *                 pi_distances.push_back(spar)
 *                 i_ind.push_back(i)
 *                 j_ind.push_back(j)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":96
 *                 j_ind.push_back(j)
 * 
 *     rp = np.array(rp_distances).astype(float)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":97
 * 
 *     rp = np.array(rp_distances).astype(float)
 *     pi = np.array(pi_distances).astype(float)             # <<<<<<<<<<<<<<
 *     i_inds = np.array(i_ind)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":98
 *     rp = np.array(rp_distances).astype(float)
 *     pi = np.array(pi_distances).astype(float)
 *     i_inds = np.array(i_ind)             # <<<<<<<<<<<<<<
 *     j_inds = np.array(j_ind)
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":99
 *     pi = np.array(pi_distances).astype(float)
 *     i_inds = np.array(i_ind)
 *     j_inds = np.array(j_ind)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":104
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pair_counter.pairwise_distance_rp_pi.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pair_counter.pairwise_distance_rp_pi.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pair_counter.pairwise_distance_rp_pi.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pair_counter.pairwise_distance_rp_pi._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pair_counter_pairwise_distance_r, __pyx_k_pair_counter_pairwise_distance_r, sizeof(__pyx_k_pair_counter_pairwise_distance_r), 0, 0, 1, 1},
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":12
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":13
 * 
 * __author__ = ('Andrew Hearin', 'Duncan Campbell')
 * __all__ = ('pairwise_distance_rp_pi', )             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_pair_counter__pairwise_distance_rp_pi) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "pair_counter.pairwise_distance_rp_pi")) {
      if (unlikely(PyDict_SetItemString(modules, "pair_counter.pairwise_distance_rp_pi", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":5
 ...
 */
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":6
 * 
 * import numpy as np
 * from scipy.sparse import coo_matrix             # <<<<<<<<<<<<<<
 * cimport numpy as cnp
 ...
 *     Cython engine for returning pairs of points and perendicular and parallel
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_12pair_counter_23pairwise_distance_rp_pi_1pairwise_distance_rp_pi, NULL, __pyx_n_s_pair_counter_pairwise_distance_r); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "pair_counter/pairwise_distance_rp_pi.pyx":1
 * """             # <<<<<<<<<<<<<<
 * """
 * from __future__ import (absolute_import, division, print_function, unicode_literals)
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pair_counter.pairwise_distance_rp_pi", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pair_counter.pairwise_distance_rp_pi");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
